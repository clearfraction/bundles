...
curl -s -L https://raw.githubusercontent.com/clearfraction/bundles/master/cf-vscodium-updater.sh -o /tmp/vscodium/usr/bin/cf-vscodium-updater && chmod +x /tmp/vscodium/usr/bin/cf-vscodium-updater
