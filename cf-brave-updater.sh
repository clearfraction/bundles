...
[[ -x data/opt/brave.com/brave ]] && sudo rm -rf /opt/3rd-party/bundles/clearfraction/opt/brave.com/brave && sudo cp -ar data/opt/brave.com/brave /opt/3rd-party/bundles/clearfraction/opt/brave.com/ && echo "updated /opt/brave.com/brave..."
[[ -x data/usr/share/appdata/brave-browser.appdata.xml ]] && sudo rm -rf /opt/3rd-party/bundles/clearfraction/usr/share/appdata/brave-browser.appdata.xml && sudo cp -ar data/usr/share/appdata/brave-browser.appdata.xml /opt/3rd-party/bundles/clearfraction/usr/share/appdata/brave-browser.appdata.xml && echo "updated brave-browser.appdata.xml..."
[[ -x data/usr/share/doc/brave-browser/changelog.gz ]] && sudo rm -rf /opt/3rd-party/bundles/clearfraction/usr/share/doc/brave-browser/changelog.gz && sudo cp -ar data/usr/share/doc/brave-browser/changelog.gz /opt/3rd-party/bundles/clearfraction/usr/share/doc/brave-browser/changelog.gz && echo "updated changelog.gz..."
[[ -x data/usr/share/gnome-control-center/default-apps/brave-browser.xml ]] && sudo rm -rf /opt/3rd-party/bundles/clearfraction/usr/share/gnome-control-center/default-apps/brave-browser.xml && sudo cp -ar data/usr/share/gnome-control-center/default-apps/brave-browser.xml /opt/3rd-party/bundles/clearfraction/usr/share/gnome-control-center/default-apps/brave-browser.xml && echo "updated gnome-control-center/default-apps/brave-browser.xml..."
[[ -x data/usr/share/man/man1/ ]] && sudo rm -rf /opt/3rd-party/bundles/clearfraction/usr/share/man/man1/brave-browser*gz && sudo cp -ar data/usr/share/man/man1/brave-browser*gz /opt/3rd-party/bundles/clearfraction/usr/share/man/man1/ && echo "updated man1/brave-browser*gz..."
[[ -x data/usr/share/menu/brave-browser.menu ]] && sudo rm -rf /opt/3rd-party/bundles/clearfraction/usr/share/menu/brave-browser.menu && sudo cp -ar data/usr/share/menu/brave-browser.menu /opt/3rd-party/bundles/clearfraction/usr/share/menu/brave-browser.menu && echo "updated menu/brave-browser.menu"
